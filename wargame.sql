...
('root', '[{\"db\":\"wargame\",\"table\":\"clear_list\"},{\"db\":\"wargame\",\"table\":\"user\"},{\"db\":\"wargame\",\"table\":\"prob\"}]');
...
('root', '2019-06-19 04:48:46', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"ko\"}');
...
-- 데이터베이스: `wargame`
--
CREATE DATABASE IF NOT EXISTS `wargame` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `wargame`;
...
CREATE TABLE `clear_list` (
  `id` varchar(40) NOT NULL COMMENT '사용자 id',
  `title` varchar(256) NOT NULL COMMENT '문제 제목',
  `time` timestamp NOT NULL DEFAULT current_timestamp() COMMENT '맞춘 시간'
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='클리어 테이블';

--
-- 테이블의 덤프 데이터 `clear_list`
--

INSERT INTO `clear_list` (`id`, `title`, `time`) VALUES
('admin', 'test', '2019-06-19 04:45:24');
...
INSERT INTO `prob` (`title`, `score`, `text`, `track`, `flag`, `author`) VALUES
('test', 100, 'test', 'web', 'flag{test}', 'noonzib');
...
('admin', 'adminroot', 600, '2019-06-18 01:18:33');
COMMIT;
